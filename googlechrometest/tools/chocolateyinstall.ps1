...
. $toolsPath\support.ps1

$filePath = if (!Get-Chrome32bitInstalled) {
       Write-Host "Installing 64 bit version" ; Get-Item $toolsDir\*_x64.msi }
else { Write-Host "Installing 32 bit version" ; Get-Item $toolsDir\*_x32.msi }
